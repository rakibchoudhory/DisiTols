    ...
    <div className="w-11/12 mx-auto px-4  my-10 flex flex-col md:flex-row justify-between gap-6">
     ...
     <div className="flex  justify-center items-center text-center md:text-start">
        ...
        <div className="flex gap-2 justify-center md:justify-start">
            ...
            <button className="btn flex items-center border-2 border-violet-600 rounded-4xl text-violet-500"><img src="/assets/Play.png" alt="" /> Watch Demo</button>
        </div>
      </div>
     </div>
      ...
      <div className=" flex justify-center md:justify-end ">
        <img className="w-[60%] md:w-[75%]  shadow-2xl" src="/assets/banner.png" alt="" />
      </div>
